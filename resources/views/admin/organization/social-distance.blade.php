                    ...
                    <fieldset>
                        <div class="at-socialdistancecontent">
                            ...
                            <div class="at-sdviolaions at-sdviolaionsvtwo">
                                @include('admin.organization.distance-violation')
                            </div>
                            <div class="at-sdviolaions at-employtracing">
                                @include('admin.organization.employ-tracing')
                            </div>
                        </div>
                    </fieldset>
                </form>
        ...
        $(document).ready(function() {
            $(function() {
                ...
                $('input[name="violation"]').on('apply.daterangepicker', function(ev, picker) {
                    ...
                    let url = '{{route('organization.distance.violation')}}';
                    let data = {
                        'date' : $('#daterange').val(),
                        'id': '{{$organization->id}}',
                    };
            ...
            $(function() {
                ...
                $('input[name="tracing"]').on('apply.daterangepicker', function(ev, picker) {
                    ...
                    let url = '{{route('organization.employ.tracing')}}';
                    let data = {
                        'date' : $('#daterange2').val(),
                        'id': '{{$organization->id}}',
                    };
            ...
            $(document).on('click','.infected',function (){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        var url="{{route('organization.account.status')}}"
