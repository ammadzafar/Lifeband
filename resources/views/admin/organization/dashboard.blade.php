...
{{--                                        @php( $temperature = body_temperature($organization->id))--}}
                                            <h3>{{count($organization->organizationUsers) > 10 ? count($organization->organizationUsers) : '0'.count($organization->organizationUsers)}}</h3>
