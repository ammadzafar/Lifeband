    ...
    <div class="at-sidebaruserdetail">
        <div class="at-userimagearea">
            <figure class="at-userimage">
                <img src="{{asset('uploads/users/images/'.$user_detail->image)}}" alt="user image">
                <span></span>
            </figure>
    ...
    <div class="at-userbodydetail">
        <ul>
            <li>
                ...
                <div>
                    <em>{{is_numeric($user_detail->height) ? $user_detail->height.' inch' : $user_detail->heigth.' cm'}}</em>
                    <span>height</span>
                </div>
            </li>
            <li>
        ...
        <div class="tab-content at-tadscontent" id="myTabContent">
            <div class="tab-pane at-temptab fade show active" id="at-temp" role="tabpanel" aria-labelledby="at-temp-tab">
                <div class="at-tabstitle">
                    <h5>temperature</h5>
                    <span>{{isset($user_detail->bodyTemperature->value) ? $user_detail->bodyTemperature->value : 0 }} {{ $user_detail->temperature_unit}}</span>
                </div>
