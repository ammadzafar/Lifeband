                    ...
                    <fieldset>
                        <div class="at-socialdistancecontent">
                            ...
                            <div class="at-sdviolaions at-sdviolaionsvtwo">
                                @include('admin.family-accounts.distance-violation')
                            </div>
                            <div class="at-sdviolaions at-employtracing">
                                @include('admin.family-accounts.employ-tracing')
                            </div>
                        </div>
                    </fieldset>
                </form>
        ...
        $(document).ready(function() {
            $(function() {
                ...
                $('input[name="violation"]').on('apply.daterangepicker', function(ev, picker) {
                    ...
                    let url = '{{route('family.distance.violation')}}';
                    let data = {
                        'date' : $('#daterange').val(),
                        'id': '{{$family_account->id}}',
                    };
            ...
            $(function() {
                ...
                $('input[name="tracing"]').on('apply.daterangepicker', function(ev, picker) {
                    ...
                    let url = '{{route('family.employ.tracing')}}';
                    let data = {
                        'date': $('#daterange2').val(),
                        'id': '{{$family_account->id}}',
                    };
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        let data = {
                            '_token': '{{csrf_token()}}',
                            'id': $(this).data('id'),
                            'account_id': '{{$family_account->id}}',
                            'status' : 'not-infected',
                        };
                        var url="{{route('family.account.status')}}"
