                            ...
                            <li>
                                <div class="at-stat">
                                    <div class="at-statcontent">
                                        <h3>{{count($users->where('account_type','individual')) > 10 ? '0'.count($users->where('account_type','individual')) : count($users->where('account_type','individual'))}}</h3>
                    ...
                    <div class="at-activepeoplewidget">
                        ...
                        <div class="at-widgetcontent">
                            <figure class="at-orgnizerimg">
                                <img src="{{asset('asset/images/family.png')}}" alt="family image">
                            </figure>
